...
<script>
import SearchBox from '@/baseComponents/search-box/search-box'
import Suggest from '@/components/suggest/suggest'
import {searchMixin} from '@/common/js/mixin'
import Switches from '@/baseComponents/switches/switches'
import Scroll from '@/baseComponents/scroll/scroll'
import {mapGetters, mapActions} from 'vuex'
import SongList from '@/baseComponents/song-list/song-list'
import Song from '@/common/js/song'
import SearchList from '@/baseComponents/search-list/search-list'
import TopTip from '@/baseComponents/top-tip/top-tip'
